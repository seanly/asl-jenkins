...
enum PipelineLibrary {
    APL_PIPELINE_LIB("apl", "seanly","asl-pipeline-library");

    final String id
    final String name
    final String organization

    PipelineLibrary(String id, String organization = "seanly", String name = null) {
        this.id = id
    ...
    static forFolder(Folder folder, ArrayList<PipelineLibrary> libs) {
